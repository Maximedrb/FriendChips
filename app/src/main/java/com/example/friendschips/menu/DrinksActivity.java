...
import com.example.friendschips.fragment.AddDrinksFragment;
...
public class DrinksActivity extends AppCompatActivity {
    ...
    private GestionFragment gestionDrinks = new GestionFragment();
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new AddDrinksFragment(), "Ajouter");
        adapter.addFrag(gestionDrinks, "Gestion");
