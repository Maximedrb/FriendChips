...
public class AddBirthdayFragment extends Fragment {
    ...
    public View onCreateView(final LayoutInflater layoutInflater, final ViewGroup viewGroup, final Bundle bundle) {
        ...
        final View view = layoutInflater.inflate(R.layout.fragmentbirthday_add, viewGroup, false);
        final Button btAddBirth = (Button)view.findViewById(R.id.btAddBirth);
        final AlertDialog.Builder alertDialog = new AlertDialog.Builder(view.getContext());

        final EditText etNomEvt = (EditText)view.findViewById(R.id.etNomEvtB);
        ...
        edtHeureDebut = (EditText)view.findViewById(R.id.edtHeureDebutB);
        edtDateFin = (EditText)view.findViewById(R.id.edtDateFinB);
        edtHeureFin = (EditText)view.findViewById(R.id.edtHeureFinB);
        ...
        btAddBirth.setOnClickListener(new View.OnClickListener() {
            @Override
